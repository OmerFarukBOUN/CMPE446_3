...
declare void @apatb_hart_hw(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @hart_hw_stub_wrapper(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @hart_hw_stub(%"struct.ap_int<32>"* %0, %"struct.ap_int<32>"* %1, %"struct.ap_int<32>"* %2)
  call void @copy_in()
  ret void
}

declare void @hart_hw_stub(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)

; Function Attrs: noinline willreturn
define void @apatb_hart_ir(%"struct.ap_int<32>"* %ret, %"struct.ap_int<32>"* nocapture readonly %inst, %"struct.ap_int<32>"* nocapture readonly %pc) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %"struct.ap_int<32>"
  call void @apatb_hart_hw(%"struct.ap_int<32>"* %0, %"struct.ap_int<32>"* %inst, %"struct.ap_int<32>"* %pc)
