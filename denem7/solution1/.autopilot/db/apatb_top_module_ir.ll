; ModuleID = '/home/omerfaruk/Projects/okul/denem7/denem7/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
declare void @apatb_top_module_hw(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @top_module_hw_stub_wrapper(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @top_module_hw_stub(%"struct.ap_int<32>"* %0, %"struct.ap_int<32>"* %1, %"struct.ap_int<32>"* %2, %"struct.ap_int<32>"* %3)
  call void @copy_in()
  ret void
}

declare void @top_module_hw_stub(%"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)

; Function Attrs: noinline willreturn
define void @apatb_top_module_ir(%"struct.ap_int<32>"* %ret, %"struct.ap_int<32>"* nocapture readonly %inst1, %"struct.ap_int<32>"* nocapture readonly %inst2, %"struct.ap_int<32>"* nocapture readonly %current_pc) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %"struct.ap_int<32>"
  call void @apatb_top_module_hw(%"struct.ap_int<32>"* %0, %"struct.ap_int<32>"* %inst1, %"struct.ap_int<32>"* %inst2, %"struct.ap_int<32>"* %current_pc)
  %1 = load volatile %"struct.ap_int<32>", %"struct.ap_int<32>"* %0
  call void @copy_back()
  %2 = load volatile %"struct.ap_int<32>", %"struct.ap_int<32>"* %0
  store %"struct.ap_int<32>" %2, %"struct.ap_int<32>"* %ret
  ret void
}
