...
declare void @apatb_top_module_hw(%"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*)
...
define void @top_module_hw_stub_wrapper(%"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*) #2 {
entry:
  call void @copy_out()
  call void @top_module_hw_stub(%"struct.ap_uint<32>"* %0, %"struct.ap_uint<32>"* %1, %"struct.ap_uint<32>"* %2, %"struct.ap_uint<32>"* %3)
  call void @copy_in()
  ret void
}

declare void @top_module_hw_stub(%"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*)

; Function Attrs: noinline willreturn
define void @apatb_top_module_ir(%"struct.ap_uint<32>"* %ret, %"struct.ap_uint<32>"* nocapture readonly %inst1, %"struct.ap_uint<32>"* nocapture readonly %inst2, %"struct.ap_uint<32>"* nocapture readonly %current_pc) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %"struct.ap_uint<32>"
  call void @apatb_top_module_hw(%"struct.ap_uint<32>"* %0, %"struct.ap_uint<32>"* %inst1, %"struct.ap_uint<32>"* %inst2, %"struct.ap_uint<32>"* %current_pc)
