...
attribute shreg_extract : string;
    ...
    signal empty_128_fu_251_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    empty_128_fu_251_p1 <= op2_val(31 - 1 downto 0);
    empty_fu_243_p1 <= op1_val(31 - 1 downto 0);
    func3_val_read_read_fu_60_p2 <= func3_val;
    func7_val_read_read_fu_66_p2 <= func7_val;
    grp_fu_207_p2 <= (empty_fu_243_p1 or empty_128_fu_251_p1);
    grp_fu_213_p2 <= (empty_fu_243_p1 xor empty_128_fu_251_p1);
    grp_fu_219_p2 <= "1" when (unsigned(op1_val) < unsigned(op2_val)) else "0";
    grp_fu_225_p2 <= "1" when (signed(op1_val) < signed(op2_val)) else "0";
    grp_fu_231_p2 <= std_logic_vector(unsigned(empty_128_fu_251_p1) + unsigned(empty_fu_243_p1));
    grp_fu_237_p2 <= (empty_fu_243_p1 and empty_128_fu_251_p1);
    ...
    rd_val_16_fu_345_p2 <= std_logic_vector(unsigned(empty_fu_243_p1) - unsigned(empty_128_fu_251_p1));
