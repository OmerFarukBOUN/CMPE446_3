...
begin
    ...
    empty_131_fu_251_p1 <= op2_val(31 - 1 downto 0);
    empty_fu_243_p1 <= op1_val(31 - 1 downto 0);
    func3_val_read_read_fu_60_p2 <= func3_val;
    func7_val_read_read_fu_66_p2 <= func7_val;
    grp_fu_207_p2 <= (empty_fu_243_p1 or empty_131_fu_251_p1);
    grp_fu_213_p2 <= (empty_fu_243_p1 xor empty_131_fu_251_p1);
    grp_fu_219_p2 <= "1" when (unsigned(op1_val) < unsigned(op2_val)) else "0";
    grp_fu_225_p2 <= "1" when (signed(op1_val) < signed(op2_val)) else "0";
    grp_fu_231_p2 <= std_logic_vector(unsigned(empty_131_fu_251_p1) + unsigned(empty_fu_243_p1));
    grp_fu_237_p2 <= (empty_fu_243_p1 and empty_131_fu_251_p1);
    op2_1_fu_381_p1 <= op2_val(5 - 1 downto 0);
    op2_2_fu_352_p1 <= op2_val(5 - 1 downto 0);
    op2_3_fu_326_p1 <= op2_val(5 - 1 downto 0);
    op2_4_fu_278_p1 <= op2_val(5 - 1 downto 0);
    op2_5_fu_259_p1 <= op2_val(5 - 1 downto 0);
    ...
    rd_val_16_fu_345_p2 <= std_logic_vector(unsigned(empty_fu_243_p1) - unsigned(empty_131_fu_251_p1));
    ...
    zext_ln105_1_fu_282_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(op2_4_fu_278_p1),32));
    zext_ln105_fu_356_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(op2_2_fu_352_p1),32));
    zext_ln109_1_fu_263_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(op2_5_fu_259_p1),32));
    zext_ln109_fu_330_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(op2_3_fu_326_p1),32));
    ...
    zext_ln88_1_fu_385_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(op2_1_fu_381_p1),32));
